  ...
  <div id="User">
    ...
    <div class="m_content">
      ...
      <div class="m_right">
        ...
        <div class="address">
          <div class="a_close"><a href="#"><img src="@/assets/static/images/a_close.png" /></a></div>
        ...
        <div class="mem_tit">
          <a href="#"><img src="@/assets/static/images/add_ad.gif" /></a>
        </div>
...
<script>
  ...
  import MyLefts from "@/components/public/Lefts";
  import MyTop2 from "@/components/public/Top2";
